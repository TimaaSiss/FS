...
<body>
    ...
    // Afficher le lien vers la page "Gestion des rôles"
    echo '<a href="usersList.php"> Gestion des Roles et Utilisateurs</a>';
} ?>  /
         <a href="historique.php">Historique des taches</a>    /   <a href="./traitement/user/deconnexion.php">Déconnexion</a>
        </div>
    </div>
</body>
</html>
