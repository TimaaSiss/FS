...
<div class="container mb-4">
  <h1> <i class="far fa-comment-alt"></i> RETOURS</h1>
      ...
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Quelle fut votre premiere impression lorsque vous etes entré 
              dans notre site?</label>     
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              ...
              width:100%" required>
                <option  selected disabled>Comment avez-vous entendus parler de nous?</option>
                <option >Moteur de recherche</option>
                <option >Réseaux Sociaux</option>
                <option >Amis/Parents</option>
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Y a-t-il quelque chose qui manqye sur cette page?</label>     
...
<footer>
	<em><h5 class="text-light text-center p-0 brand mt-2">
			...
			ELITE'AIR</h5></em>
	<p class="text-light text-center">&copy; <?php echo date('Y');?> - Developpé par Maimouna et Fatoumata</p>
</footer>