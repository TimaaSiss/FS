...
?>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center text-light">PAYER SA FACTURE</h1>
            ...
            <form action="includes/payment.inc.php" method="post" 
                ...
                <div class="form-group">
                    <label for="cc-number" class="control-label mb-1">Numéro de carte</label>
                    <input id="cc-number" name="cc-number" type="tel" class="form-control cc-number identified visa" required autocomplete="off"  >
                    <span class="invalid-feedback">Entrez un numéro de carte valide de 12 à 16 chiffres</span>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <span class="invalid-feedback">Entrez la date d'expiration</span>
                        </div>
                    </div>
                    <div class="col-6 p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col pr-0">                            
                                <span class="invalid-feedback order-last">Entrez le code à 3 chiffres de l'arriere</span>
