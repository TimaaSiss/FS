...
.dashbord-red .detail-section{
      ...
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#flight">Vols d'aujourd'hui</a>
              <a class="dropdown-item" href="#issue">Probleme des vols d'aujourd'hui</a>
              <a class="dropdown-item" href="#dep">Vols partis aujourd'hui</a>
              <a class="dropdown-item" href="#arr">Vols arrivés aujourd'hui</a>
            </div>
          </div>        
        <p class="text-secondary">Vol d'aujourd'hui</p>
    ...
    <div class="card" id="issue">
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#flight">Vol d'aujourd'hui</a>
              <a class="dropdown-item" href="#issue">Probleme du vold'aujourd'hui</a>
              <a class="dropdown-item" href="#dep">Vols partis aujourd'hui</a>
              <a class="dropdown-item" href="#arr">Vols arrivés aujourd'hui</a>
            </div>
          </div>        
        <p class="text-secondary">Probleme du vol d'aujourd'hui</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
    ...
    <div class="card" id="dep">
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#flight">Vol d'aujourd'hui</a>
              <a class="dropdown-item" href="#issue">Probleme du vol d'aujourd'hui</a>
              <a class="dropdown-item" href="#dep">Vols partis aujourd'hui</a>
              <a class="dropdown-item" href="#arr">Vols arrivés aujourd'hui</a>
            </div>
          </div>        
        <p class=" text-secondary">Vols partis aujourd'hui</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
    ...
    <div class="card mb-4" id="arr">
      <div class="card-body">
        ...
        <p class=" text-secondary">Vols arrivés aujourd'hui</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
