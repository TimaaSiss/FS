...
<div class="container mt-0">
  <div class="row">
    ...
    ?><!-- log on to codeastro.com for more projects -->
      ...
      <h1 class="text-secondary text-center">AJOUTER LES DETAILS DU VOL</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row mb-4">
          <div class="col-md-3 p-0">
            <h5 class="mb-0 form-name">DEPART</h5>
          </div>
        ...
        <div class="form-row mb-4">
        <div class="col-md-3 ">
            <h5 class="form-name mb-0">ARRIVEE</h5>
          </div>          
          <div class="col">
        ...
        <button name="flight_but" type="submit" 
          ...
          <i class="fa fa-lg fa-arrow-right"></i> Proceder
          </div>
        </button>
      </form>
    </div>
