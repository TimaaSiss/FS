  ...
  h4 {
    ...
    <body>
        ...
        <nav class="navbar navbar-custom navbar-expand-lg navbar-dark">
          <a class="navbar-brand text-light" href="index.php"><h4>PANNEAU ADMIN</h4></a>
              ...
              if(isset($_SESSION['adminId'])) { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php">
                      <h5 class="ml-2"> Tableau de bord</h5>
                    </a>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" href="flight.php">
                      <h5 class="ml-2"> Ajouter un vol</h5>
                    </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <div class="dropdown mt-2">
                      <button class="btn bg-transparent dropdown-toggle text-white" type="button" 
                        ...
                        <i class="fa fa-plus text-white"></i>Compagnies </td>
                      </button>  
                      <div class="dropdown-menu">
                        <form class="px-2 py-2"  action="../includes/admin/airline.inc.php" method="post">
                          ...
                          <button type="submit" name="air_but" 
                            class="btn btn-success w-100">Soumettre</button>
                        </form>
                      </div>
                    </div>  
                  </li>
