				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="to">
								<h3 style="color: rgba(255, 255, 255, 0.767);">A</h3>
								<?php
								$sql = 'SELECT * FROM Cities ';
								$stmt = mysqli_stmt_init($conn);
								mysqli_stmt_prepare($stmt,$sql);         
							...
							<div class="date">
								...
								<div class="return">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Retour</h3>
							...
							<div class="numofppl">
								<div class="adults">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Passager</h3>
									<div class="quantity"> 
					...
					<div class="tab-1 resp-tab-content oneway">
						<form action="book_flight.php" method="post">
							...
							<div class="clear"></div>
							<input type="submit" value="Rechercher des vols" name="search_but">
						</form>																				
	</div><!-- log on to codeastro.com for more projects -->
	</div>
	</div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            ...
                                            <div class="intro_subtitle">
                                                <p>Qu'est ce qu'il y a sur votre liste de voyage?</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            ...
                                            <div class="intro_subtitle"><!-- log on to codeastro.com for more projects -->
                                                <p>Visitez vos endroits favoris a des prix raisonnables</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Des services incroyables</div>
                                            <div class="intro_subtitle">
                                                <p>De bonnes interactions commencent par connaitre les désirs et les besoins de vos clients.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
			...
			ELITE'AIR</h5></em>
	<div class="text-light text-center">&copy; <?php echo date('Y')?> - Developpé par Maimouna et Fatoumata<br><br></div>
	<!-- <p>----------</p> -->
