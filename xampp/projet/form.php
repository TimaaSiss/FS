	...
	<form method="post" action="insert.php">
		...
		<p><label>Nom:</label><input type="text" name="pseudo"/><br><br>
		  <label> Prenom:</label><input type="text" name="prenom"/><br><br>
		   <label>Telephone:</label><input type="number" name="phone"/><br><br>
		   <label>Email:</label><input type="email" name="mail"/><br><br>
		   <label>Sexe:</label><input type="radio" name="gender" /> 
